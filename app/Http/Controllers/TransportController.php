...
class TransportController extends Controller
{
    public function store(Request $request){
        ...
        Transport::create([
           ...
           'd_phone'=>$request->phno,
           'd_addr'=>$request->add1,
           'd_addr2'=>$request->add2,
           'd_postal'=>$request->postal,
           'd_country'=>$request->country,
           'd_city'=>$request->city,
           'd_region'=>$request->reg,
        'p_name'=>$request->p_name,
        'p_phone'=>$request->p_phno,
        'p_addr'=>$request->p_add1,
        'p_addr2'=>$request->p_add2,
        'p_postal'=>$request->p_postal,
        'p_country'=>$request->p_country,
        'p_city'=>$request->p_city,
        'p_region'=>$request->p_reg,
